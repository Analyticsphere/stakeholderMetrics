response_ratio_by_race_uc <- function(data){
  ...
  rr_data <- rr_data %>%
    mutate(rr = case_when(
      year %in% c(2020, 2023) ~ rr / 100,  # Divide by 100 for years 2022 and 2023
      year == 2024 ~ rr / 100,  # Divide by 100 for February 2024
