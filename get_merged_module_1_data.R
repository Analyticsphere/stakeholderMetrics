get_merged_module_1_data <- function(project) {
  ...
  #variables = the column of variable names that should be pulled from both versions of module 1
...
'
  # Run the query
  query_m1_v1 <- bq_project_query(project_id, sql_query)
